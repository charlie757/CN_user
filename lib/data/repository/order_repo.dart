...
class OrderRepo {
  ...
  Future<ApiResponse> offlinePaymentPlaceOrder(String addressID, String couponCode,String couponDiscountAmount, String billingAddressId, String orderNote, String paymentBy, String transactionId, String paymentNote) async {
    try {
      ...
      print('dsfdf... ${AppConstants.offlinePayment}?address_id=$addressID&coupon_code=$couponCode&coupon_discount=$couponDiscountAmount&billing_address_id=$billingAddressId&order_note=$orderNote&payment_by=$paymentBy&transaction_ref=$transactionId&payment_note=$paymentNote');
