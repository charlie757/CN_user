...
import 'package:flutter_sixvalley_ecommerce/provider/service_provider.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => AddNewMemberRepo(dioClient: sl()));
  sl.registerLazySingleton(() => TeamMemberRepo(dioClient: sl()));
  sl.registerLazySingleton(() => ViewMemberRepo(dioClient: sl()));
  ...
  sl.registerFactory(() => AddNewMemberProvider(addNewMemberRepo: sl()));
  sl.registerFactory(() => TeamMemberProvider(teamMemberRepo: sl()));
  sl.registerFactory(() => ViewMemberProvider(viewMemberRepo: sl()));
