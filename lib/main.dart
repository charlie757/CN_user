...
Future<void> main() async {
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(
          create: (context) => di.sl<AddNewMemberProvider>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<TeamMemberProvider>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<ViewMemberProvider>()),
      ChangeNotifierProvider(
          create: (context) => di.sl<ServiceProvider>()),
    ],
