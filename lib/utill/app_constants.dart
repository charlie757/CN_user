...
class AppConstants {
  static const String appName = 'Consumer Networks';
  static const String appVersion = '14.0';
  static const String baseUrl = 'https://www.consumersnetworks.com/testing';
  ...
  static const String servicesUrl ='/api/v1/products/services?limit=10&&offset=';
  ...
  static const String countryUri = '/api/v1/country';
  static const String stateUri = '/api/v1/state/';
  static const String cityUri = '/api/v1/city/';
  static const String addMemeberUrl = '/api/v1/customer/add-member';
  static const String directMemberUri = '/api/v1/customer/team-member';
  static const String totalMemberUri = '/api/v1/customer/all-team-member?';
  static const String userTeamMemberUri = '/api/v1/customer/user-team-member/';
  static const String searchDirectMemberUri = '/api/v1/customer/team-member?search=';
  static const String searchTotalMemberUri = '/api/v1/customer/all-team-member?page=';
