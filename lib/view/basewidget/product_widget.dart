            ...
            Container(
              ...
              child: ClipRRect(
                ...
                CachedNetworkImage(
                  ...
                  placeholder: (context, url) => Image.asset(Images.placeholder,fit: BoxFit.cover,height: MediaQuery.of(context).size.width/2.45,),
                  errorWidget: (context, url, error) => Image.asset(Images.placeholder, fit: BoxFit.cover,height: MediaQuery.of(context).size.width/2.45,),
                ),),
            ),
