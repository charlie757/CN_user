...
import 'package:flutter_sixvalley_ecommerce/view/screen/more/add_new_member_screen.dart';
import 'package:flutter_sixvalley_ecommerce/view/screen/more/team_member_screen.dart';
          ...
          child: Consumer<ProfileProvider>(
            builder: (context, profile, child) {
              return Row(children: [
                ...
                //   //     !isGuestMode
                //   //         ? profile.userInfoModel != null
                //   //             ? '${profile.userInfoModel!.fName} ${profile.userInfoModel!.fName}'
                //   //             : 'Full Name'
                //   //         : 'Guest',
                //   //     style: titilliumRegular.copyWith(
                //   //         color: ColorResources.white),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                  ...
                  TitleButton(
                      image: Images.myProfileImage,
                      title: getTranslated('addMember', context),
                      navigateTo: () {
                        if (isGuestMode) {
                          showAnimatedDialog(context, const GuestDialog(),
                              isFlip: true);
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) => const AddNewMemberScreen()),
                          );
                        }
                      }),
                  TitleButton(
                      image: Images.myProfileImage,
                      title: getTranslated('teamMember', context),
                      navigateTo: () {
                        if (isGuestMode) {
                          showAnimatedDialog(context, const GuestDialog(),
                              isFlip: true);
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => const TeamMemberScreen()),
                        );}
                      }),
