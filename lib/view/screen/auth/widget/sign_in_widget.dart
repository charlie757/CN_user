...
class SignInWidgetState extends State<SignInWidget> {
  ...
  openSellerLink() async {
    final Uri url =
    Uri.parse('https://www.consumersnetworks.com/shop/apply-mobile');
    if (!await launchUrl(url, mode: LaunchMode.externalApplication)) {
      throw Exception('Could not launch $url');
    }
  }
  openMemberLink() async {
    final Uri url =
    Uri.parse('https://www.consumersnetworks.com/customer/auth/sign-up-member');
    if (!await launchUrl(url, mode: LaunchMode.externalApplication)) {
      throw Exception('Could not launch $url');
    }
  }
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.transparent, borderRadius: BorderRadius.circular(6),),
                child: Text(getTranslated('become_a_member', context)!,
                    style: titleHeader.copyWith(color: ColorResources.getPrimary(context))),
              ),
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.transparent, borderRadius: BorderRadius.circular(6),),
                child: Text(getTranslated('become_a_supplier', context)!,
                    style: titleHeader.copyWith(color: ColorResources.getPrimary(context))),
              ),
            ),
