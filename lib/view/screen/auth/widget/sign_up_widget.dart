...
class SignUpWidgetState extends State<SignUpWidget> {
  ...
  openWebsiteLink() async {
    final Uri url =
        Uri.parse('https://consumersnetworks.com/customer/auth/sign-up');
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(getTranslated('toRegisterAccountClickBelowAccount', context)!,
              textAlign: TextAlign.center, style: titleHeader),
          const SizedBox(
            height: 30,
          ),
          CustomButton(
              onTap: openWebsiteLink,
              buttonText: getTranslated('registerAccount', context))
        ],
      ),
    );
    //   ListView(
