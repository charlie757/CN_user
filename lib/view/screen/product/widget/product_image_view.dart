                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      child:   CachedNetworkImage(
                        imageUrl: '${Provider.of<SplashProvider>(context,listen: false).baseUrls!.productImageUrl}/${productModel!.images![index]}',
                        fit: BoxFit.cover,height: MediaQuery.of(context).size.width,
