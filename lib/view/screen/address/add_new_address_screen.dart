...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  void initState() {
    ...
    country = 'BD';
    //  = country;
    Provider.of<LocationProvider>(context, listen: false).initcountryApi();
                          ...
                          child: SizedBox(
                            child: Column(
                              ...
                              children: [
                                ...
                                customDropDown(
                                  context: context,
                                  itemList: locationProvider.countryList,
                                  value: locationProvider.countrydropdownvalue,
                                  hintText: 'Select country',
                                  onChanged: (dynamic newValue) {
                                    setState(() {
                                      locationProvider.countrydropdownvalue =
                                          newValue;
                                      locationProvider.initstateyApi(
                                ...
                                customDropDown(
                                  context: context,
                                  itemList: locationProvider.stateList,
                                  value: locationProvider.statedropdownvalue,
                                  hintText: 'Select state',
                                  onChanged: (dynamic newValue) {
                                    setState(() {
                                      locationProvider.statedropdownvalue =
                                          newValue;
                                      locationProvider.initcityApi(
                                          newValue['id'].toString());
                                    });
                                  },
                                ),
                                ...
                                customDropDown(
                                  context: context,
                                  itemList: locationProvider.cityList,
                                  value: locationProvider.citydropdownvalue,
                                  hintText: 'Select city',
                                  onChanged: (dynamic newValue) {
                                    setState(() {
                                      print(newValue);
                                      locationProvider.citydropdownvalue =
                                          newValue;
                                    });
                                  },
                                ),
