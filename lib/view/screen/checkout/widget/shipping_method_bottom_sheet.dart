      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Consumer<CartProvider>(
          builder: (context, order, child) {
            return
              order.shippingList!.isNotEmpty&& order.shippingList![widget.sellerIndex].shippingMethodList != null ? order.shippingList![widget.sellerIndex].shippingMethodList!.isNotEmpty ?  SizedBox(
              height: 300,
